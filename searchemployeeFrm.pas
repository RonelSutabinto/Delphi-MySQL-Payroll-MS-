...
type
  TsearchEmployee = class(TForm)
    ...
    empDS: TMyDataSource;
    empQemployeestatus: TStringField;
...
procedure TsearchEmployee.AdvSmoothButton9Click(Sender: TObject);
begin
  pagibigsavings.idemployee_tf.Text := empQidemployee.Text;
  pagibigsavings.empnumber_tf.Text  := empQempnumber.Text;
  pagibigsavings.name_tf.Text := empQname.Text;
  pagibigsavings.department_tf.Text := empQdepartment.Text;
  pagibigsavings.empstatus_tf.Text := empQemployeestatus.Text;
  Close;
end;
