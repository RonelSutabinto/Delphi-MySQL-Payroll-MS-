object BudgetoptForm: TBudgetoptForm
  ...
  object PayeeSearch: TMyQuery
    ...
    object PayeeSearchidpayee: TLongWordField
      FieldName = 'idpayee'
    end
  ...
  object paytobudgetchart: TMyQuery
    ...
    Left = 8
    Top = 80
    object paytobudgetchartidchart: TLongWordField
      FieldName = 'idchart'
    end
    object paytobudgetchartidpcode: TLongWordField
      FieldName = 'idpcode'
    end
  ...
  object MyQuery1: TMyQuery
    Connection = PayrollData.MyConnection1
    SQL.Strings = (
      'select * from paytobudget')
    Left = 8
    Top = 144
    object MyQuery1idPaytoBudget: TLongWordField
      FieldName = 'idPaytoBudget'
    end
    object MyQuery1pCode: TStringField
      FieldName = 'pCode'
      Size = 45
    end
    object MyQuery1pName: TStringField
      FieldName = 'pName'
      Size = 45
    end
    object MyQuery1accountdmo: TStringField
      FieldName = 'accountdmo'
      Size = 15
    end
    object MyQuery1pcodepao: TStringField
      FieldName = 'pcodepao'
      Size = 45
    end
    object MyQuery1pNamePao: TStringField
      FieldName = 'pNamePao'
      Size = 45
    end
    object MyQuery1accountpao: TStringField
      FieldName = 'accountpao'
      Size = 15
    end
    object MyQuery1pcodesao: TStringField
      FieldName = 'pcodesao'
      Size = 45
    end
    object MyQuery1pNamesao: TStringField
      FieldName = 'pNamesao'
      Size = 45
    end
    object MyQuery1accountsao: TStringField
      FieldName = 'accountsao'
      Size = 15
    end
    object MyQuery1pcodelao: TStringField
      FieldName = 'pcodelao'
      Size = 45
    end
    object MyQuery1pnamelao: TStringField
      FieldName = 'pnamelao'
      Size = 45
    end
    object MyQuery1Accountlao: TStringField
      FieldName = 'Accountlao'
      Size = 15
    end
    object MyQuery1accountsss: TStringField
      FieldName = 'accountsss'
      Size = 45
    end
    object MyQuery1accountph: TStringField
      FieldName = 'accountph'
      Size = 45
    end
    object MyQuery1accountpag: TStringField
  ...
  object SearchAccount: TMyQuery
    ...
    object SearchAccountidchart: TLongWordField
      FieldName = 'idchart'
    end
